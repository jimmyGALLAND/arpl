...
#PLATFORMS["7.2"]="broadwellnk:4.4.301 r1000:4.4.302"
...
prepare
echo "Building ${TOOLKIT_VER}"
#docker image rm jimmygalland/syno-compiler:${TOOLKIT_VER} >/dev/null 2>&1
#docker buildx build . --load --tag jimmygalland/syno-compiler:${TOOLKIT_VER} --tag jimmygalland/syno-compiler:latest


docker image rm git.celjim.fr/jimmygalland/syno-compiler:${TOOLKIT_VER}-debian10 >/dev/null 2>&1
docker buildx build . --load --tag git.celjim.fr/jimmygalland/syno-compiler:${TOOLKIT_VER}-debian10
